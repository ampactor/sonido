...
Structured walkthrough for testing every aspect of the Sonido CLI, TUI, and GUI.
...
| # | Command | Pass |
|---|---------|------|
| 1 | `cargo run -p sonido-cli -- process test_audio/sine_440.wav /tmp/out.wav --effect preamp --param gain=6` | [ ] |
| 2 | `cargo run -p sonido-cli -- process test_audio/sine_440.wav /tmp/out.wav --effect distortion --param drive=15` | [ ] |
| 3 | `cargo run -p sonido-cli -- process test_audio/noise.wav /tmp/out.wav --effect compressor --param threshold=-20` | [ ] |
...
| 11 | `cargo run -p sonido-cli -- process test_audio/sine_440.wav /tmp/out.wav --effect phaser --param rate=0.3 --param depth=0.8` | [ ] |
| 12 | `cargo run -p sonido-cli -- process test_audio/sine_440.wav /tmp/out.wav --effect multivibrato --param depth=0.5` | [ ] |
| 13 | `cargo run -p sonido-cli -- process test_audio/sine_440.wav /tmp/out.wav --effect delay --param time=300 --param feedback=0.4` | [ ] |
| 14 | `cargo run -p sonido-cli -- process test_audio/sine_440.wav /tmp/out.wav --effect tape --param drive=12` | [ ] |
| 15 | `cargo run -p sonido-cli -- process test_audio/sine_440.wav /tmp/out.wav --effect reverb --param mix=0.5 --param room_size=0.8` | [ ] |
...
cargo run -p sonido-cli -- process test_audio/sine_440.wav /tmp/smoke.wav --effect reverb --param mix=0.5 && echo "PASS: process"
cargo run -p sonido-cli -- process test_audio/sine_440.wav /tmp/smoke.wav --chain "distortion:drive=10|delay:time=300|reverb:mix=0.3" && echo "PASS: chain"
...
Try a different terminal emulator. Ensure terminal supports 256 colors and is at least 80x24.
